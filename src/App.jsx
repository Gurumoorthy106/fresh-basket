    ...
    >
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <motion.aside
          ...
          className="fixed bottom-6 right-6 w-80 bg-white rounded-2xl shadow-2xl p-4 z-40"
        >
          ...
          <motion.button
            ...
            className="mt-4 w-full py-2 rounded-md bg-gradient-to-r from-emerald-500 to-green-600 text-white font-semibold disabled:opacity-50"
          >
            Checkout
          </motion.button>
        </motion.aside>
        ...
        <footer className="mt-auto bg-gradient-to-r from-emerald-600 to-green-700 text-white py-6 text-center relative overflow-hidden">
          ...
          <motion.div
            className="flex justify-center gap-6 mt-2 text-2xl"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 1 }}
          >
            <a
              href="https://www.instagram.com/__gurumoorthy__/"
              target="_blank"
            ...
            <a
              href="mailto:gurumoorthy2022004@gmail.com"
              className="hover:text-yellow-300 hover:scale-125 transition-transform"
              title="Email"
            >
              <FaEnvelope />
            </a>
